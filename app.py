...
def convert_docx_to_pdf_libreoffice(docx_path, pdf_path):
    ...
    Platform independent and container friendly
    """
...
def process_docx(docx_path: str) -> tuple:
    ...
    try:
        ...
        # Convert DOCX to PDF
        pdf_path = os.path.join(temp_dir, "converted.pdf")
        conversion_success = convert_docx_to_pdf_libreoffice(docx_path, pdf_path)
...
def display_docx(file):
    ...
    try:
        ...
        # Convert DOCX to PDF with COM init
        # Convert DOCX to PDF using LibreOffice (platform independent)
        pdf_path = os.path.join(temp_dir, "converted.pdf")
        conversion_success = convert_docx_to_pdf_libreoffice(docx_path, pdf_path)
